...
import (
	...
	apisCluster "github.com/hops-ops/provider-listmonk/apis/cluster"
	apisNamespaced "github.com/hops-ops/provider-listmonk/apis/namespaced"
	"github.com/hops-ops/provider-listmonk/config"
	"github.com/hops-ops/provider-listmonk/internal/clients"
	controllerCluster "github.com/hops-ops/provider-listmonk/internal/controller/cluster"
	controllerNamespaced "github.com/hops-ops/provider-listmonk/internal/controller/namespaced"
	"github.com/hops-ops/provider-listmonk/internal/features"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("provider-listmonk"))
	if *debug {
		ctrl.SetLogger(zl)
	}
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID:           "crossplane-leader-election-provider-listmonk",
