...
1. Visit [Tag Workflow Action](https://github.com/hops-ops/provider-listmonk/actions/workflows/tag.yaml)
...
1. Run the [CI Workflow Action](https://github.com/hops-ops/provider-listmonk/actions/workflows/ci.yml)
   by clicking on the "Run workflow" button. Make sure the "Branch" is set to the release branch, e.g., `release-0.1`.
1. Create a new GitHub Release
   at [New Release](https://github.com/hops-ops/provider-listmonk/releases/new).
...
Create or patch the [Release Branch](#release-branches) from the `main` branch. You could use visit [Branches](https://github.com/hops-ops/provider-listmonk/branches)
