...
import (
	...
	clusterv1beta1 "github.com/hops-ops/provider-listmonk/apis/cluster/v1beta1"
	namespacedv1beta1 "github.com/hops-ops/provider-listmonk/apis/namespaced/v1beta1"
)
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal listmonk credentials as JSON"
)
